...
object StreamsApp extends cask.MainRoutes {
  ...
  props.put(StreamsConfig.APPLICATION_SERVER_CONFIG, serviceHost + ":" + servicePort.toString)
  props.put(StreamsConfig.STATE_DIR_CONFIG, s"./data/stock-state-$servicePort")
